...
func RequestCredentials(req *http.Request) (*UserInfo, error) {
...
func DestinationAddr(req *http.Request) (string, error) {
...
func destAddr(addr string) (string, error) {
...
func forwardDest(dest string) (string, error) {
...
func setErrorMessage(header http.Header, message string) {
