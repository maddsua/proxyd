...
type MethodHandler interface {
	OnStatus(ctx context.Context, token *InstanceToken, params model.InstanceStatus) error
	OnTraffic(ctx context.Context, token *InstanceToken, params model.InstanceTrafficUpdate) error
	OnProxyTable(ctx context.Context, token *InstanceToken) (*model.ProxyTable, error)
}
...
func sendRPCHandler[R any](procedure func(ctx context.Context, token *InstanceToken) (*R, error)) http.Handler {
...
func receiveRPCHandler[T any](procedure func(ctx context.Context, token *InstanceToken, params T) error) http.Handler {
...
func requestToken(req *http.Request) (*InstanceToken, error) {
